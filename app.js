...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <p class="product-rating-color">Rating: <span class="product-rating-color"> ${product.rating.rate}</span></p>
      <p class="product-rating-color">Rating Count: ${product.rating.count}</p>
